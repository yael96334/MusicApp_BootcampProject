            ...
            <ThemeProvider theme={theme}>
                <ValidationGroup>
                    <Container component="main" maxWidth="xs">
                        ...
                        <Validate name="internal key 1" required={[true, 'title song is a required field']}>
                                    ...
                                    <Grid item xs={12} sm={6}>
                                        ...
                                        <Validate name="internal key 2" required={[true, 'length is a required field']}>
                                    ...
                                    <Grid item xs={12} sm={6}>
                                        <Validate name="internal key 2" required={[true, 'price is a required field']}>
